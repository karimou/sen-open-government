import{s as _,_ as $,b as V}from"./AppOpinion-DP-84lXD.js";import{u as w,t as N,q as v,r as j,x as D,o as p,d as x,e as g,b as a,g as h,j as B,f as y,s as P,F as C,a as I,c as k,l as z,B as A}from"./index-DtJ711I_.js";const E={class:"font-bold"},L={__name:"AppCandidateOpinionsPanel",props:{candidateId:{type:Number},opinions:{type:Object,default:[]},collapsed:{type:Boolean,default:!0}},setup(i){const n=w(),e=i,{opinions:t,candidateId:c,collapsed:l}=N(e),s=v(()=>n.getCandidate(c.value)),u=v(()=>{if(s.value)return`${s.value.firstname} ${s.value.lastname}`}),m=v(()=>{var f;return(f=t.value)==null?void 0:f.map(o=>Number(o.num_proposals)).filter(o=>!!o).reduce((o,r)=>o+r,0)}),d=j(!1);D(()=>{d.value=l.value});const S=()=>d.value=!d.value;return(f,o)=>(p(),x(a(V),{collapsed:d.value,toggleable:"",class:"w-full my-2"},{header:g(()=>{var r;return[y("div",{class:"flex align-items-center gap-2 cursor-pointer",onClick:o[0]||(o[0]=b=>S())},[h(a(_),{image:(r=s.value)==null?void 0:r.photo,size:"large",shape:"rectangle"},null,8,["image"]),y("span",E,B(u.value),1),h(a(P),{value:m.value,severity:"success"},null,8,["value"])])]}),default:g(()=>[(p(!0),k(C,null,I(a(t),(r,b)=>(p(),x($,{opinion:r,includeDivider:b!=a(t).length-1},null,8,["opinion","includeDivider"]))),256))]),_:1},8,["collapsed"]))}},F={class:"p-button-label"},M={__name:"AppCandidatesSelector",emits:["scroll"],setup(i,{emit:n}){const e=w(),t=n,c=(l,s)=>{t("scroll",l),s&&s.target.blur()};return(l,s)=>(p(!0),k(C,null,I(a(e).currentElection.candidates,u=>(p(),x(a(z),{class:"mx-2",text:"",size:"small",severity:"primary",onClick:m=>c(u.id,m)},{default:g(()=>[h(a(_),{image:u.photo,shape:"circle",class:"mr-1"},null,8,["image"]),y("span",F,B(a(e).getCandidateName(u.id)),1)]),_:2},1032,["onClick"]))),256))}};var O=`
@layer primevue {
    .p-carousel {
        display: flex;
